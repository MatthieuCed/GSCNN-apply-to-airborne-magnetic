...
if os.getcwd().split('\\')[0] == 'G:':
    __C.DATASET.CITYSCAPES_DIR= 'G:/Mon disque/'
else:
    __C.DATASET.CITYSCAPES_DIR= '/content/gdrive/My Drive/'
    
# __C.DATASET.CITYSCAPES_DIR= '/content/gdrive/My Drive/' # 'G:/Mon disque/' # /home/username/data/cityscapes'
...
def assert_and_infer_cfg(args, make_immutable=True):
    ...
    if args.syncbn:
        ...
        # __C.MODEL.BNFUNC = torch.nn.BatchNorm2d # a changer sinon
    else:
        __C.MODEL.BNFUNC = torch.nn.BatchNorm2d
